...
(function () {
  ...
  if (typeof document !== "undefined" && document.createElement && document.head) {
    ...
    style.textContent = [
      ...
      ".hub-overlay.hub-money .v16-hub-body,.hub-overlay.hub-money .v11-hub-body,.hub-overlay.hub-money [data-hub-body='money']{overflow-x:hidden!important}",
      ".v1837-money-shell{display:grid;gap:14px;padding:4px 0 90px;min-width:0;color:#f6ead8}.v1837-money-shell *{box-sizing:border-box}.v1837-money-shell .panel{min-width:0;overflow:hidden;border:1px solid rgba(216,173,109,.22);border-radius:12px;background:linear-gradient(135deg,rgba(36,30,23,.96),rgba(23,19,15,.96));padding:14px}.v1837-money-shell .section-label{color:#d8b16e;font-family:'JetBrains Mono',monospace;font-size:10px;letter-spacing:.16em;text-transform:uppercase;margin-bottom:9px}.v1837-note{margin:0;color:#d6c5aa;font-family:'JetBrains Mono',monospace;font-size:11px;line-height:1.5}",
